...
public class WelcomePanel extends JPanel {
	...
	public static void InitializePanel(){		
		...
		btnNewDatabase.setIcon(new ImageIcon(SandboxTestPane.class.getResource("/uk/co/pori/WineBrewDB/Images/newbig.png")));
		...
		btnLoadDatabase.setIcon(new ImageIcon(SandboxTestPane.class.getResource("/uk/co/pori/WineBrewDB/Images/loadbig.png")));
