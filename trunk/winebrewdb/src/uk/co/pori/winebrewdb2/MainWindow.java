...
public class MainWindow {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				if(!WineBrewDBConfigFile.exists()){
			    	InputStream content = MainWindow.class.getResourceAsStream("/uk/co/pori/WineBrewDB/WineBrewDBConfig.ini");
	...
	public void initialize() {
		...
		URL img32 = MainWindow.class.getResource("/uk/co/pori/WineBrewDB/Images/winebrewdb32.png");
		URL img64 = MainWindow.class.getResource("/uk/co/pori/WineBrewDB/Images/winebrewdb64.png");
		URL img128 = MainWindow.class.getResource("/uk/co/pori/WineBrewDB/Images/winebrewdb128.png");
		URL img256 = MainWindow.class.getResource("/uk/co/pori/WineBrewDB/Images/winebrewdb256.png");
