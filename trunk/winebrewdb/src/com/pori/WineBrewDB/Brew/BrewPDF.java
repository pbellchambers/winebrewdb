...
public class BrewPDF {
	...
	private static void addBrewData(Document document)
		...
		genericParagraph.add(new Paragraph("Date Planned: " + Dates.dateToString(BrewDataPanel.chooserBrewDatePlannedB.getDate()) + "          Date Started: " + Dates.dateToString(BrewDataPanel.chooserBrewDateStartedB.getDate()) + "          Date Bottled: " + Dates.dateToString(BrewDataPanel.chooserBrewDateBottledB.getDate()), text2));
		genericParagraph.add(new Chunk(ls));
		addEmptyLine(genericParagraph, 1);
		
		genericParagraph.add(new Paragraph("Recipe From:",smallBold));
		addEmptyLine(genericParagraph, 3);
	...
	private static void addBrewNotes(Document document) throws DocumentException {
		...
		addEmptyLine(genericParagraph, 1);
		//Header
		genericParagraph.add(new Paragraph("Brew Notes", heading1Font));
		addEmptyLine(genericParagraph, 1);
		// Add a table
	...
	private static void addBrewCosts(Document document) throws DocumentException {
		...
		addEmptyLine(genericParagraph, 1);
		//Header
		genericParagraph.add(new Paragraph("Brew Costs", heading1Font));
		addEmptyLine(genericParagraph, 1);
		// Add a table
	...
	private static void addBrewPictures(Document document) throws DocumentException {
		...
		addEmptyLine(genericParagraph, 1);
		//Header
		genericParagraph.add(new Paragraph("Brew Pictures", heading1Font));
		addEmptyLine(genericParagraph, 1);
		// Add a table
