...
public class MainWindow {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				if(!WineBrewDBConfigFile.exists()){
			    	InputStream content = MainWindow.class.getResourceAsStream("/WineBrewDBConfig.ini");
	...
	private void initialise() {
		...
		URL img16 = MainWindow.class.getResource("/images/winebrewdb16.png");
		URL img32 = MainWindow.class.getResource("/images/winebrewdb32.png");
		URL img64 = MainWindow.class.getResource("/images/winebrewdb64.png");
		URL img128 = MainWindow.class.getResource("/images/winebrewdb128.png");
		URL img256 = MainWindow.class.getResource("/images/winebrewdb256.png");
