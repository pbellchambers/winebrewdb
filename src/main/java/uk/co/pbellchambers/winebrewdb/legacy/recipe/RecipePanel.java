...
public class RecipePanel extends JPanel {
	...
	public static void initialisePanel(){
		...
		btnPrintRecipe.setIcon(new ImageIcon(RecipePanel.class.getResource("/images/print.png")));
		...
		tabbedRecipePane.addTab("Add New Recipe", new ImageIcon(RecipePanel.class.getResource("/images/new.png")), RecipeAddPanel.tabbedRecipeAddPanel, null);
		...
		LegacyApp.WineBrewDBFrame.getContentPane().add(RecipePanel, "cell 0 0,grow");
	...
	public static void deinitialisePanel(){
		if(RecipePanelStatus.equals("Initialised")) {
			...
			LegacyApp.WineBrewDBFrame.getContentPane().remove(RecipePanel);
