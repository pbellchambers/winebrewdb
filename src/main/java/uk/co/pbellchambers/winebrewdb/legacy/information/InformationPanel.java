...
public class InformationPanel extends JPanel {
	...
	public static void initialisePanel(){
		...
		LegacyApp.WineBrewDBFrame.getContentPane().add(InformationPanel, "cell 0 0,grow");
	...
	public static void deinitialisePanel(){
		if(InformationPanelStatus.equals("Initialised")) {
			...
			LegacyApp.WineBrewDBFrame.getContentPane().remove(InformationPanel);
	...
	public static void dynamicallyAddTabs(){
		...
		tabbedInformationPane.addTab("Add/Edit Tabs", new ImageIcon(InformationPanel.class.getResource(
            "/images/new.png")), InformationEditTab.tabbedInformationEditTab, null);
	}
