package uk.co.pbellchambers.winebrewdb.brew;
...
public class BrewPanel extends JPanel {
	...
	public static void initialisePanel(){
		...
		btnPrintBrew.setIcon(new ImageIcon(BrewPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/print.png")));
		...
		tabbedBrewPane.addTab("Add New Brew", new ImageIcon(BrewPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/new.png")), BrewAddPanel.tabbedBrewAddPanel, null);
