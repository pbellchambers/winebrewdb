...
public class MeasuresPanel extends JPanel {
	...
	public static void initialisePanel(){
		...
		btnWeightToGrams.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/right.png")));
		MeasuresSubPanel.add(btnWeightToGrams, "cell 4 3");
		
		JButton btnWeightToOz = new JButton();
		btnWeightToOz.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/left.png")));
		...
		btnTspToTbsp.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/right.png")));
		MeasuresSubPanel.add(btnTspToTbsp, "cell 11 3");

		JButton btnTbspToTsp = new JButton();
		btnTbspToTsp.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/left.png")));
		...
		btnUKToUSGallons.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/right.png")));
		MeasuresSubPanel.add(btnUKToUSGallons, "cell 4 6");

		JButton btnUSToUKGallons = new JButton();
		btnUSToUKGallons.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/left.png")));
		...
		btnUKGallonsToLitres.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/right.png")));
		MeasuresSubPanel.add(btnUKGallonsToLitres, "cell 11 6");

		JButton btnLitresToUKGallons = new JButton();
		btnLitresToUKGallons.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/left.png")));
		...
		btnCToF.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/right.png")));
		MeasuresSubPanel.add(btnCToF, "cell 4 9");

		JButton btnFToC = new JButton();
		btnFToC.setIcon(new ImageIcon(MeasuresPanel.class.getResource("/uk/co/pbellchambers/winebrewdb/images/left.png")));
