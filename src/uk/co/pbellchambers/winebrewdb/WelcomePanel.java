...
public class WelcomePanel extends JPanel {
	...
	public static void initialisePanel(){		
		...
		btnNewDatabase.setIcon(new ImageIcon(SandboxTestPane.class.getResource("/uk/co/pbellchambers/winebrewdb/images/newbig.png")));
		...
		btnLoadDatabase.setIcon(new ImageIcon(SandboxTestPane.class.getResource("/uk/co/pbellchambers/winebrewdb/images/loadbig.png")));
