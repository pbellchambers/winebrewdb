 ...
 *
 * Modified by Paul Bellchambers 2012
 */
...
public class JDateChooser extends JPanel {
    ...
    private Color colorBackgroundChange = Color.WHITE;
    ...
    private Action onComboButtonClick = new AbstractAction() {
		private static final long serialVersionUID = -8127709282959721787L;
    ...
    private Action onSelectDate = new AbstractAction() {
		private static final long serialVersionUID = 5855755107990401052L;
		public void actionPerformed(ActionEvent e) {
    ...
    public void setEnabled() {
        ...
        comboBoxButton.setEnabled(true);
        dateField.setBackground(colorBackgroundChange);
    }
    
    public void setDisabled() {
        dateField.setEditable(false);
        comboBoxButton.setEnabled(false);
        dateField.setBackground((UIManager.getColor("Panel.background")));
    }
